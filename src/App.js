                ...
                <div className="container">
                    <div className="row margin-bottom">
                        <div className="col-lg-4">
                            <div className="heading heading--primary"><span className="heading__pre-title color--green"></span>
                                <h2 className="heading__title no-margin-bottom"><span>Project</span> <span>Section</span></h2>
                            </div>
                        </div>
                        <div className="col-lg-8">
                            <p className="causes__heading-text">Start your Creative Projects in the categories like Art, Comics, Crafts, Dance, Design, Fashion, Film & Video, Food, Games, Journalism, Music, Photography, Publishing, Technology, and Theater. Provide your innovative project title with project description and funding amount.</p>
                        </div>
                    </div>
                                                    ...
                                                    (item.c_starter === web3.eth.defaultAccount) ? "" : (
                                                        <div className="causes-item__action">
                                                            ...
                                                            <a
                                                                ...
                                                                data-toggle="modal" data-target={'#donateModal'} href="#_">+ Donate </a>
                                                        </div>
                                                    )
                                                }
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                ...
                                <div className={'form-group'}>
                                    <label htmlFor="">Enter Funding Goal</label>
